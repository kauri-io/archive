...
[consensus](https://bitcoin.org/en/glossary/consensus). The validation rules these
...
[merkle root](https://bitcoin.org/en/glossary/merkle-root) of a merkle tree.
...
Outputs are tied to [transaction identifiers (TXIDs)](https://bitcoin.org/en/glossary/txid), which are the hashes
...
[Unspent Transaction Outputs (UTXOs)](https://bitcoin.org/en/glossary/unspent-transaction-output) or spent transaction outputs. For a
...
fee](https://bitcoin.org/en/glossary/transaction-fee) by the Bitcoin
[miner](https://bitcoin.org/en/glossary/mining) who creates the block containing that
transaction.
...
The [proof of work](https://bitcoin.org/en/glossary/proof-of-work) used in Bitcoin
...
that a given hash attempt will generate a number below the [target](https://bitcoin.org/en/glossary/nbits)
threshold.
...
least as challenging as a [difficulty](https://bitcoin.org/en/glossary/difficulty) value expected by the consensus protocol.
...
could you reliably execute such a [51 percent attack](https://bitcoin.org/en/glossary/51-percent-attack) against
...
by their [block height](https://bitcoin.org/en/glossary/block-height) ---the number of blocks between them and the first Bitcoin
...
creates an apparent [fork](https://bitcoin.org/en/glossary/fork) in the block chain, as shown in the
illustration above.
...
to recreate and throw away [stale blocks](https://bitcoin.org/en/glossary/stale-block) belonging to shorter forks.
...
identifier (txid). From these txids, the [merkle tree](https://bitcoin.org/en/glossary/merkle-tree) is constructed by pairing each
...
[User Activated Soft Forks](https://bitcoin.org/en/glossary/uasf) (UASF) as
...
forks are known as [Miner Activated Soft Forks](https://bitcoin.org/en/glossary/masf) (MASF)
